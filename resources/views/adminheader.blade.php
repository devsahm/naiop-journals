   <header class="main-header">
            <div class="gx-toolbar">
                ...
                <a class="site-logo" href="index.html">
                   <!--  <img src="/adminassets/images/logo.png" alt="Jumbo" title="Jumbo"> -->
                </a>
                            ...
                            <div class="dropdown-menu-perfectscrollbar">
                                <div class="messages-list">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="media">
                                            <img alt="domnic-harris" src="/adminassets/images/userAvatar/domnic-harris.jpg"
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="media">
                                            <div class="user-thumb">
                                                <img alt="Domnic Harris" src="/adminassets/images/userAvatar/domnic-harris.jpg" class="size-40 rounded-circle user-avatar">
