        ...
        <div class="gx-main-content">
            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0">Update Password</h2>
                    <nav class="mb-0 breadcrumb">
                        <a href="/admin" class="breadcrumb-item">Dashboard</a>
                       
                        <span class="active breadcrumb-item">Update Password</span>
                    </nav>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="gx-card">
                            ...
                            <div class="gx-card-body">
                               <form class="form" method="post" action="/admin/passwordupdate/{{ Auth::guard('admin')->id() }}">
                                @csrf
                                @method('PATCH')
                                ...
                                @include('customerror')
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Old Password</label>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">New Password</label>
                                        <div class="col-md-10 col-sm-9">
                                      ...
                                      <div class="line-dashed"></div>
                                    <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Confirm New Password</label>
                                        <div class="col-md-10 col-sm-9">
