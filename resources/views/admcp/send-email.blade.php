        ...
        <div class="modal-content">
            <div class="modal-box-content d-flex flex-column">
                ...
                <form  method="post" action="/admin/confirmation">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="exampleInputSubject" name="subject" placeholder="Subject" value="ACCEPTANCE OF PAPER FOR PUBLICATION" required>
                    </div>

                    <div class="form-group">
                        <textarea id="summernote" name="message" readonly>
                            Dear {{ $WriterInstance->name }},<br><br>
