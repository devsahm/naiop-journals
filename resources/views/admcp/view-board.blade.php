            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Uploaded Editorial Board Details</h2>
                        <nav class="mb-0 breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                            
                            <span class="active breadcrumb-item">Editorial Board List</span>
                        </nav>
                    </div>
                                        ...
                                        <table class="table table-users default-table table-hover">
                                            ...
                                            <tr>
                                               ...
                                               <td><?php echo $counter; ?></td>
                                                ...
                                                <td> {{ date('h:i a', strtotime( $board->created_at)) }}</td>
                                                <td>Volume {{$board->volume_number}} No.{{ $board->issue_number}}</td>
                                                <td>
                                                  <div>
                                                    <a href="/board/{{ $board->id }}/edit" class="btn btn-info" style="margin-left: 20px" ><i class="fa fa-eye-slash"></i>Edit</a>
                                                </div>
                                                </td>
