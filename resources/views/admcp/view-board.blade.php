            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Publication- Editorial Board</h2>
                        <nav class="mb-0 breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                            
                            <span class="active breadcrumb-item">Editorial Board</span>
                        </nav>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-users default-table table-hover">
                                            ...
                                            <tr>
                                               <th>S/N</th>
                                              <th>Publication</th>
                                              <th>Add/Edit Editorial Board</th>
                                            </tr>
                                             <?php $counter=1; ?>
                                            @if($issues->count())
                                            ...
                                            <tr>
                                               ...
                                               <td><?php echo $counter; ?></td>
                                                ...
                                                <td>
                                                  <div>
                                                    <a href="/admin/editorial-board/action/{{$issue->id}}" class="btn btn-info" style="margin-left: 20px" ><i class="fa fa-eye"></i>Add/Edit</a>
                                                </div>
                                                </td>
