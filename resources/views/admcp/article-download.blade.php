            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Article Downloads Registration</h2>
                        <nav class="mb-0 breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                            
                            <span class="active breadcrumb-item">Article Downloads Registration</span>
                        </nav>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-users default-table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <form method="post" action="/downloadsuser/{{ $user->id }}">
                                                 @method('DELETE')
                                                 @csrf
                                                <button type="Submit" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger"><i class="fa fa-trash"></i>Delete</button>
                                                </form>
                                                </td>
                                             <?php $counter++; ?>
                                            </tr>
                                            ...
                                            @else
                                                ...
                                                <p style="margin:auto;">no registration record was found</p>
