                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-users default-table table-hover">
                                            ...
                                            <tr>
                                              ...
                                              <!--   <td class= </td>"text-center"><div class="form-checkbox"><input type="checkbox" class="form-control" value="value2" name="name2"> <span class="check"></span></div></td> -->
                                              <td><a href="/admin/send-email/{{ $article->id }}" class="btn btn-primary">Acceptance Email</a></td>
