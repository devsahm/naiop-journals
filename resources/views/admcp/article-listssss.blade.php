                        ...
                        <div class="col-md-12 col-12">
                            <div class="shadow border-0 card">
                                <div class="card-header">
                                   Volume {{ $issue->volume_id }} No. {{ $issue->issue }} ({{ $issue->month }}) {{ $issue->volume_year}}
                                </div>
                                ...
                                <li>
                                    <h3><a class="mb-4" href="/article/{{ $article->id }}" style="text-decoration: underline;">{{ $article->title }}</a> pg {{ $article->pagenumber }}</h3>
