        ...
        <div class="gx-main-content">
            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0">Edit Editors Note</h2>
                    <nav class="mb-0 breadcrumb">
                        <a href="/admin" class="breadcrumb-item">Dashboard</a>
        
                       
                        <span class="active breadcrumb-item">Edit Editors Note</span>
                    </nav>
                </div>
                        ...
                        <div class="gx-card">
                            ...
                            <div class="gx-card-body">
                                ...
                                @include('errors')
                                 @include('customerror')
                                @include('success')
                               <form class="form" method="post" action="/editor/{{$editor->id}}">
                                @method('PATCH')
                                @csrf
                      
                               <h4  style="text-align: center;">Volume {{$editor->volume_number}} No.{{ $editor->issue_number}}</h4>

                               <h2 style="text-align: center;"><b>EDITORS NOTE</b></h2>
                                    ...
                                    <div class="line-dashed"></div>
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-12 col-sm-10">
                                          <textarea id="summernote" name="editors_note" required>{{$editor->editors_note}}</textarea>
                                        </div>
                                    </div>          
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12" style="text-align: center; ">
                                            ...
                                            <button type="submit" class="btn btn-primary">Update Editors Note</button>
                                        </div>
                                    </div>
                                </form>
