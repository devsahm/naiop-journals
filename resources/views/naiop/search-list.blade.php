...
<html lang="en">
  <head>
    ...
    <!-- Title-->
    <title>NAIOP | Article Lists</title>
    ...
    <div class="row">
      <div class="col-lg-9">
       ...
       @if($articles->count())
        ...
        <!--   <div class="col-md-4 px-md-0">
          ...
          <div class="col-md-12 px-md-0" style="width: 100%">
            <div class="card height-100p shadow-v1">
              <div class="card-body">
                <a href="/journal/issue/article-detials/{{ $article->id }}" class="h4 mb-3">
                  {{ $article->title }}
                </a>
                <!-- <p class="mb-0">
                 ...
                 <div class="media">
                  <!--  <img class="iconbox" src="/assets/img/avatar/5.jpg" alt=""> -->
                   <div class="media-body ml-4">
                     <a class="text-primary"><i style="color: black">Author:</i> {{ $article->author }}</a> 
                   </div>
                 </div>
               </div>
            </div>
        ...
        @endforeach
        @else
           <div class="card height-100p shadow-v1" style="height: 50px">
              <div class="card-body">
...
<!--       
      ...
      <div class="widget">
         ...
         <ul>
          ...
          <li><a>Published Article ({{$volumes->count() }})</a></li>
